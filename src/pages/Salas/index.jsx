...
const Salas = () => {
  ...
  },
  {
    ...
    selector: (row) => (
      <Actions>
        ...
        onClick={() => {
          ...
          setLateralEditar(true)}} ></box-icon>
        <box-icon 
        name='trash'
    ...
    const cadastrarSala = (dados) => {
      dados.sala_id = salas.length + 1;it 
    ...
    return(
      ...
      <Overlay className={lateralCriar || lateralEditar ? 'active' : ''} 
      onClick={() => {
        setLateralCriar(false);
        setLateralEditar(false);
        }}/>
        ...
        <Lateral className={lateralCriar && 'active'}>
          ...
          <Body>
            <form onSubmit={handleSubmit(cadastrarSala)}>
             ...
             <Button title={'Salvar'} classes={'telatoda'} type='submit'/>
            </form>
          </Body>
        </Lateral>
        ...
        <Lateral className={lateralEditar && 'active'}>
          ...
          <Body>
            <form onSubmit={handleSubmitEditar(atualizarSala)}>
             <Input type="hidden" { ...registerEditar('sala_editar')}/>
             <Label>Nome</Label>
             <Input placeholder="Digite o nome da sala" 
